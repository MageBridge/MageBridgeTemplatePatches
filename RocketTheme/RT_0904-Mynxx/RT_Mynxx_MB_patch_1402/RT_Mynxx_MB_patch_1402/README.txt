...
These files modify the RocketTheme Mynxx template so that the MageBridge shop integrates nicely with it. Note that these files only work in combination with the default Magento theme.
...
2) Copy all files inside the "rt_template" folder to the RocketTheme template-directory (for instance "templates/rt_mynxx_j15") or your custom copy of this template.
